...
if __name__=='__main__':
    ...
    feature_path_list = [DATA_DIREC+'Influenza/split_feature_group/abundance_feature_Influenza.csv',
                        DATA_DIREC+'Influenza/split_feature_group/localization_feature_Influenza.csv',
                        DATA_DIREC+'Influenza/split_feature_group/ppi_feature_Influenza.csv',
                        DATA_DIREC+'Influenza/split_feature_group/go_feature_Influenza.csv',
    ...
    calc_Comparison_Metrics(feature_path_list,feature_list,n_fold=5,
                        ...
                        data_name = 'Feature_group_comparison_Influenza_',
